...
let libhardware_legacy = (function () {
  ...
  return {
    ...
    ifc_set_addr: library.declare("ifc_set_addr", ctypes.default_abi, ctypes.int, ctypes.char.ptr, ctypes.unsigned),
    ifc_set_mask: library.declare("ifc_set_addr", ctypes.default_abi, ctypes.int, ctypes.char.ptr, ctypes.unsigned),

    ifc_create_default_route: library.declare("ifc_create_default_route", ctypes.default_abi, ctypes.int, ctypes.char.ptr, ctypes.unsigned),

    ifc_get_info: library.declare("ifc_get_info", ctypes.default_abi, ctypes.unsigned.ptr, ctypes.unsigned.ptr, ctypes.unsigned.ptr)
  };
};
